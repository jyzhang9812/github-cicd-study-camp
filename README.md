...
本勉強会では、各チームが学習中に自由に質問できるよう
専用の [Custom GPT（CICDStudyngTemp）](https://chatgpt.com/g/g-691dce579db881b8ad74c52b837a7427-cicd4ke-mian-qiang-hui-zhuan-yong-kasutamugpt)を用意しています。
- 書籍やCI/CDに関する質問を即時確認可能
- 不明点は Slack スレッドにも共有OK
